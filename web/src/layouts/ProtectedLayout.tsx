...
const MORE_ITEMS = [
  ...
  { to: '/payroll/trainers', label: 'Trainer Payroll', icon: navIcon('M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6') },
  { to: '/payroll/students', label: 'Student Payroll', icon: navIcon('M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6') },
