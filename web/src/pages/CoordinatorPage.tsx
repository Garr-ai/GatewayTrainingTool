    ...
    <div className="flex w-full h-full min-h-0 flex-1 overflow-hidden bg-slate-900">
      <aside className="w-56 bg-gradient-to-b from-slate-900 to-slate-800 text-slate-100 px-4 py-5 flex flex-col gap-6">
        ...
        <nav className="flex flex-col gap-1" aria-label="Main navigation">
          <button
            className="w-full rounded-lg px-3 py-2 text-left text-sm bg-slate-700/70"
            type="button"
          >
            Dashboard
          </button>
          <button className="w-full rounded-lg px-3 py-2 text-left text-sm hover:bg-slate-700/40" type="button">
            Classes
          </button>
          <button className="w-full rounded-lg px-3 py-2 text-left text-sm hover:bg-slate-700/40" type="button">
            Settings
      ...
      <section className="flex-1 bg-slate-100 px-6 py-5 flex flex-col gap-4">
        <header className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col items-end gap-1">
              <span className="text-[10px] font-semibold tracking-[0.16em] uppercase text-slate-500">
                Coordinator
              </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <section className="rounded-xl bg-white p-4 shadow-sm min-h-[110px]">
            ...
            <p className="text-xs text-slate-500">
              Upcoming competency and graduation reviews.
            </p>
          </section>
        </div>
        ...
        {/* Reserved space for future dashboard widgets */}
