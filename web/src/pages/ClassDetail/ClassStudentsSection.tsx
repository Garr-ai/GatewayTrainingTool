...
export function ClassStudentsSection({ className }: ClassStudentsSectionProps) {
  return (
    <section className="rounded-xl bg-white p-4 shadow-sm">
      ...
      <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-6 text-center text-xs text-slate-500">
        Enrolled students for <span className="font-medium text-slate-700">{className}</span> will be
        listed here.
      </div>
    </section>
  )
